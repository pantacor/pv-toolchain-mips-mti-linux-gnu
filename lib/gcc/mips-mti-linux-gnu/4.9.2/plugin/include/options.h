...
enum opt_code
{
  ...
  OPT_mabs_ = 1071,                          /* -mabs= */
  OPT_mandroid = 1072,                       /* -mandroid */
  OPT_march_ = 1073,                         /* -march= */
  OPT_mbionic = 1074,                        /* -mbionic */
  OPT_mblockmov_limit_ = 1075,               /* -mblockmov-limit= */
  OPT_mbranch_cost_ = 1076,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1077,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1078,           /* -mcheck-zero-division */
  OPT_mclib_ = 1079,                         /* -mclib= */
  OPT_mcode_readable_ = 1080,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1081,             /* -mcompact-branches= */
  OPT_mdead_loads = 1082,                    /* -mdead-loads */
  OPT_mdebug = 1083,                         /* -mdebug */
  OPT_mdebugd = 1084,                        /* -mdebugd */
  OPT_mdivide_breaks = 1085,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1086,                  /* -mdivide-traps */
  OPT_mdmx = 1087,                           /* -mdmx */
  OPT_mdouble_float = 1088,                  /* -mdouble-float */
  OPT_mdsp = 1089,                           /* -mdsp */
  OPT_mdspr2 = 1090,                         /* -mdspr2 */
  OPT_mdspr3 = 1091,                         /* -mdspr3 */
  OPT_meb = 1092,                            /* -meb */
  OPT_mel = 1093,                            /* -mel */
  OPT_membedded_data = 1094,                 /* -membedded-data */
  OPT_mepi = 1095,                           /* -mepi */
  OPT_mepi_ = 1096,                          /* -mepi= */
  OPT_meva = 1097,                           /* -meva */
  OPT_mexplicit_relocs = 1098,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1099,                  /* -mextern-sdata */
  OPT_mfix_24k = 1100,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1101,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1102,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1103,                     /* -mfix-r4400 */
  OPT_mfix_rm7000 = 1104,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1105,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1106,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1107,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1108,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1109,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1110,                   /* -mflush-func= */
  OPT_mforbidden_slots = 1111,               /* -mforbidden-slots */
  OPT_mfp_exceptions = 1112,                 /* -mfp-exceptions */
  OPT_mfp32 = 1113,                          /* -mfp32 */
  OPT_mfp64 = 1114,                          /* -mfp64 */
  OPT_mfpxx = 1115,                          /* -mfpxx */
  OPT_mframe_header_opt = 1116,              /* -mframe-header-opt */
  OPT_mfunc_opt_list_ = 1117,                /* -mfunc-opt-list= */
  OPT_mfused_madd = 1118,                    /* -mfused-madd */
  OPT_mglibc = 1119,                         /* -mglibc */
  OPT_mgp32 = 1120,                          /* -mgp32 */
  OPT_mgp64 = 1121,                          /* -mgp64 */
  OPT_mgpopt = 1122,                         /* -mgpopt */
  OPT_mgrow_frame_downwards = 1123,          /* -mgrow-frame-downwards */
  OPT_mhard_float = 1124,                    /* -mhard-float */
  OPT_mimadd = 1125,                         /* -mimadd */
  OPT_minline_intermix = 1126,               /* -minline-intermix */
  OPT_minterlink_compressed = 1127,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1128,              /* -minterlink-mips16 */
  OPT_mips = 1129,                           /* -mips */
  OPT_mips16 = 1130,                         /* -mips16 */
  OPT_mips3d = 1131,                         /* -mips3d */
  OPT_mllsc = 1132,                          /* -mllsc */
  OPT_mload_store_pairs = 1133,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1134,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1135,                    /* -mlong-calls */
  OPT_mlong32 = 1136,                        /* -mlong32 */
  OPT_mlong64 = 1137,                        /* -mlong64 */
  OPT_mlra = 1138,                           /* -mlra */
  OPT_mmad = 1139,                           /* -mmad */
  OPT_mmcount_ra_address = 1140,             /* -mmcount-ra-address */
  OPT_mmcu = 1141,                           /* -mmcu */
  OPT_mmemcpy = 1142,                        /* -mmemcpy */
  OPT_mmicromips = 1143,                     /* -mmicromips */
  OPT_mmips16_copy_peep = 1144,              /* -mmips16-copy-peep */
  OPT_mmips16_tail_branch = 1145,            /* -mmips16-tail-branch */
  OPT_mmips16_tail_indirect = 1146,          /* -mmips16-tail-indirect */
  OPT_mmips16_use_xsregs = 1147,             /* -mmips16-use-xsregs */
  OPT_mmips16_ze_policy_ = 1148,             /* -mmips16-ze-policy= */
  OPT_mmips16e2 = 1149,                      /* -mmips16e2 */
  OPT_mmsa = 1150,                           /* -mmsa */
  OPT_mmt = 1151,                            /* -mmt */
  OPT_mmxu = 1152,                           /* -mmxu */
  OPT_mnan_ = 1153,                          /* -mnan= */
  OPT_mno_float = 1154,                      /* -mno-float */
  OPT_mno_flush_func = 1155,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1156,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1157,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1158,                     /* -mno-mips3d */
  OPT_modd_spreg = 1159,                     /* -modd-spreg */
  OPT_mpaired_single = 1160,                 /* -mpaired-single */
  OPT_mplt = 1161,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1162,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1163,               /* -mrelax-pic-calls */
  OPT_msched_weight = 1164,                  /* -msched-weight */
  OPT_msdata_num_ = 1165,                    /* -msdata-num= */
  OPT_msdata_opt_list_ = 1166,               /* -msdata-opt-list= */
  OPT_mshared = 1167,                        /* -mshared */
  OPT_msingle_float = 1168,                  /* -msingle-float */
  OPT_msmartmips = 1169,                     /* -msmartmips */
  OPT_msoft_float = 1170,                    /* -msoft-float */
  OPT_msplit_addresses = 1171,               /* -msplit-addresses */
  OPT_msym32 = 1172,                         /* -msym32 */
  OPT_msynci = 1173,                         /* -msynci */
  OPT_mtune_ = 1174,                         /* -mtune= */
  OPT_muclibc = 1175,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1176,        /* -muninit-const-in-rodata */
  OPT_muse_copyw_by_pieces = 1177,           /* -muse-copyw-by-pieces */
  OPT_muse_save_restore = 1178,              /* -muse-save-restore */
  OPT_mvirt = 1179,                          /* -mvirt */
  OPT_mvr4130_align = 1180,                  /* -mvr4130-align */
  OPT_mxgot = 1181,                          /* -mxgot */
  OPT_mxpa = 1182,                           /* -mxpa */
  OPT_n = 1183,                              /* -n */
  OPT_no_canonical_prefixes = 1184,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1185,              /* -no-integrated-cpp */
  OPT_noasmopt = 1186,                       /* -noasmopt */
  ...
  OPT_pie = 1199,                            /* -pie */
  OPT_pipe = 1200,                           /* -pipe */
  OPT_posix = 1201,                          /* -posix */
  OPT_print_file_name_ = 1202,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1203,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1204,          /* -print-multi-directory */
  OPT_print_multi_lib = 1205,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1206,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1207,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1208,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1209,               /* -print-prog-name= */
  OPT_print_search_dirs = 1210,              /* -print-search-dirs */
  OPT_print_sysroot = 1211,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1212,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1213,                        /* -profile */
  OPT_pthread = 1214,                        /* -pthread */
  OPT_quiet = 1215,                          /* -quiet */
  OPT_r = 1216,                              /* -r */
  OPT_rdynamic = 1217,                       /* -rdynamic */
  OPT_remap = 1218,                          /* -remap */
  OPT_s = 1219,                              /* -s */
  OPT_s_bc_abi = 1220,                       /* -s-bc-abi */
  OPT_save_temps = 1221,                     /* -save-temps */
  OPT_save_temps_ = 1222,                    /* -save-temps= */
  OPT_shared = 1223,                         /* -shared */
  OPT_shared_libgcc = 1224,                  /* -shared-libgcc */
  /* OPT_specs = 1225, */                    /* -specs */
  OPT_specs_ = 1226,                         /* -specs= */
  OPT_static = 1227,                         /* -static */
  OPT_static_libasan = 1228,                 /* -static-libasan */
  OPT_static_libgcc = 1229,                  /* -static-libgcc */
  OPT_static_libgcj = 1230,                  /* -static-libgcj */
  OPT_static_libgfortran = 1231,             /* -static-libgfortran */
  OPT_static_libgo = 1232,                   /* -static-libgo */
  OPT_static_liblsan = 1233,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1234,               /* -static-libstdc++ */
  OPT_static_libtsan = 1235,                 /* -static-libtsan */
  OPT_static_libubsan = 1236,                /* -static-libubsan */
  /* OPT_std_c__03 = 1237, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1238, */                /* -std=c++0x */
  OPT_std_c__11 = 1239,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1240, */                /* -std=c++14 */
  OPT_std_c__1y = 1241,                      /* -std=c++1y */
  ...
  OPT_std_gnu__98 = 1259,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1260,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1261, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1262, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1263,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1264,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1265, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1266, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1267,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1268, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1269, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1270, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1271,                     /* -std=legacy */
  OPT_symbolic = 1272,                       /* -symbolic */
  OPT_t = 1273,                              /* -t */
  OPT_time = 1274,                           /* -time */
  OPT_time_ = 1275,                          /* -time= */
  OPT_tno_android_cc = 1276,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1277,                 /* -tno-android-ld */
